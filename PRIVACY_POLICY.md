...
This privacy policy applies to the Easy Signature app (hereby referred to as "Application") for mobile devices that was created by Samed Harman (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".
